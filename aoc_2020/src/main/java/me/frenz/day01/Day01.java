...
public class Day01 extends Day<Util.Triple<Integer, Integer, Integer>, Integer> {
    ...
    @Override
    protected Util.Triple<Integer, Integer, Integer> part1() {
        return findPair();
    }

    @Override
    protected Integer part2() {
        Util.Triple<Integer, Integer, Integer> result = findPair();
        return result.getLeft() * result.getRight() * result.getCenter();
    }
