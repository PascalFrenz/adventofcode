...
class Day4Test {
    ...
    void testGetPassports_GivenExample() {
        final Iterator<String> passports = Day4.getPassports(exampleInput).iterator();
    ...
    void testCountValidPassports_givenExample() {
        final List<String> passports = Day4.getPassports(exampleInput);
        assertEquals(2, Day4.countCompletePassports(passports));
    }
}